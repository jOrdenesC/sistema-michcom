...
import ModalComponent from "../components/modal_users";
...
export default function Users() {
    ...
    const columns = [
        {
            name: 'Avatar',
            cell: row => <img className="w-10 h-10 rounded" src={image} alt={row} />,
            sortable: true
        },
        {
            name: 'Nombre',
        ...
        },
        {
            ...
            name: 'Cargo',
            selector: row => <p className="capitalize">{row.charge}</p>,
            sortable: true
        },
    ];
    ...
    return (
        <>
            ...
            <ModalComponent open={open} close={handleClose} data={{ type: type, row: selectedUser }} />
        </>
    )
}
