...
import ModalProviders from "../components/modal_providers";
...
export default function Providers() {
  ...
  const columns = [
    ...
    },
    {
      ...
      name: 'Giro',
      selector: row => <p className="capitalize">{row.giro}</p>,
      sortable: true
    }, {
      name: 'Dirección',
  ...
  return (
    <>
      ...
      <ModalProviders open={open} close={handleClose} data={{ type: type, row: selectedUser }} />
    </>
  )
}
