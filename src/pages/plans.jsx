...
import ModalPlans from "../components/modal_plans";
...
export default function Plans() {
  ...
  const columns = [
    {
      name: 'Servicio',
      selector: row => <p className="capitalize">{row.services.title}</p>,
      sortable: true
    },
    {
      name: 'Nombre',
    ...
    {
      name: 'Valor',
      selector: row => <p className="capitalize">{row.price} {row.divisa}</p>,
      sortable: true
    }
  ];
  ...
  return (
    <>
      ...
      <br />
      <p className="text-xl font-bold" >Planes</p>
      <br />
      {loading ?
        <>
      ...
      <ModalPlans open={open} close={handleClose} data={{ type: type, row: selectedPlan }} />
    </>
  )
}
