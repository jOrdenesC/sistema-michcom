...
export default function ModalClients({ open, close, data }) {
                                ...
                                <div className="relative p-6 flex-auto">
                                    <div className='flex'>
                                        <div className='w-1/2 p-6'>
                                            <div className="mb-6">
                                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rut de cliente</label>
                                                <input onChange={(e) => {
                                            ...
                                            <div className="mb-6">
                                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de cliente</label>
                                                <input onChange={(e) => {
                                        ...
                                        <div className='w-1/2 p-6'>
                                            <div className="mb-6">
                                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teléfono de cliente</label>
                                                <input onChange={(e) => {
                                            ...
                                            <div className="mb-6">
                                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dirección de cliente</label>
                                                <input onChange={(e) => {
